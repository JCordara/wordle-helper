...
extern CharArray in_word;   // Letters that must be in the word
extern CharSet possible[5]; // Possible letters in each position

// Convenience alphabet string
static String alphabet = "abcdefghijklmnopqrstuvwxyz";

// Struct containing word information
typedef struct WORD {
    WORD(String str, int s) : letters(str), score(s) {}
    String letters;
    int score;
} Word;
...
static StringArray common_words = {
 ...
 "acorn", "actor", "acute", "adapt", "adept", "admit", "adobe", "adopt", 
 "adore", "adult", "affix", "afoot", "after", "again", "agape", "agent", 
 "agile", "aging", "agony", "agree", "ahead", "aisle", "alarm", "album", 
 "alert", "algae", "alibi", "alien", "align", "alike", "alive", "alley", 
 "allow", "alloy", "aloft", "alone", "along", "aloud", "alpha", "altar", 
 "alter", "amass", "amaze", "amber", "amend", "among", "ample", "amuse", 
 "angel", "anger", "angle", "angry", "anime", "ankle", "annoy", "anvil", 
 "aorta", "apart", "aphid", "apple", "apply", "apron", "arena", "argue", 
 "arise", "armor", "aroma", "arose", "array", "arrow", "arson", "artsy", 
 "aside", "askew", "asset", "attic", "audio", "audit", "avoid", "await", 
 "awake", "award", "aware", "awful", "awoke", "azure", "bacon", "badge", 
 "badly", "bagel", "baggy", "baker", "balmy", "banjo", "barge", "baron", 
 "basic", "basil", "basin", "basis", "batch", "bathe", "baton", "bayou", 
 "beach", "beard", "beast", "beefy", "began", "begin", "begun", "being", 
 "belch", "belly", "below", "bench", "beret", "berry", "bible", "bicep", 
 "binge", "bingo", "birch", "birth", "bison", "black", "blade", "blame", 
 "bland", "blank", "blast", "blaze", "bleak", "bleed", "blend", "bless", 
 "blimp", "blind", "blink", "bliss", "blitz", "bloat", "block", "blond", 
 "blood", "bloom", "blown", "bluff", "blunt", "blurt", "blush", "board", 
 "boast", "boney", "bongo", "bonus", "boost", "booth", "booty", "bushy", 
 "booze", "borne", "bosom", "bossy", "bound", "bowel", "boxer", "brace", 
 "braid", "brain", "brake", "brand", "brass", "brave", "bravo", "brawl", 
 "bread", "break", "breed", "briar", "bribe", "brick", "bride", "brief", 
 "brine", "bring", "brisk", "broad", "broke", "brook", "broom", "broth", 
 "brown", "brunt", "brush", "brute", "buddy", "buggy", "bugle", "build", 
 "built", "bulge", "bulky", "bully", "bunch", "bunny", "burnt", "burst", 
 "buyer", "bylaw", "cabin", "cable", "cache", "cadet", "camel", "canal",
 "candy", "canoe", "canon", "carat", "cargo", "carol", "carry", "carve", 
 "catch", "cater", "cause", "cease", "cedar", "cello", "chafe", "chaff",
 "chain", "chair", "chalk", "champ", "chant", "chaos", "charm", "chart",
 "chase", "cheap", "cheat", "check", "cheek", "cheer", "chess", "chest", 
 "chick", "chief", "child", "chili", "chill", "chime", "china", "chirp", 
 "choir", "choke", "chord", "chore", "chose", "chuck", "chump", "chunk", 
 "chute", "cider", "cigar", "civic", "civil", "claim", "clamp", "clank",
 "clash", "class", "clean", "clear", "clerk", "click", "cliff", "climb", 
 "cling", "cloak", "clock", "clone", "close", "cloth", "cloud", "clout", 
 "clown", "clump", "coach", "coast", "cobra", "cocoa", "colon", "color", 
 "comet", "comfy", "comic", "comma", "condo", "coral", "corny", "couch", 
 "cough", "could", "count", "coupe", "court", "cover", "covet", "cower", 
 "crack", "craft", "cramp", "crane", "crank", "crash", "crate", "crave", 
 "crawl", "crazy", "creak", "cream", "creed", "creek", "creep", "crepe", 
 "crest", "cried", "crime", "crisp", "croak", "crook", "cross", "crowd", 
 "crown", "crude", "cruel", "crumb", "crush", "crust", "crypt", "cubic", 
 "curly", "curry", "curse", "curve", "curvy", "cutie", "cyber", "cycle", 
 "daddy", "daily", "dairy", "daisy", "dance", "dandy", "dealt", "death", 
 "debit", "debug", "debut", "decal", "decay", "decor", "decoy", "defer", 
 "deity", "delay", "delta", "delve", "demon", "denim", "dense", "depot", 
 "depth", "derby", "deuce", "devil", "diary", "dicey", "digit", "diner", 
 "dirty", "disco", "ditch", "ditto", "diver", "dizzy", "dodge", "dodgy", 
 "doing", "donor", "donut", "doubt", "dough", "dozen", "draft", "drain", 
 "drake", "drama", "drank", "drape", "drawl", "drawn", "dread", "dream", 
 "dress", "dried", "drier", "drift", "drill", "drink", "drive", "drone", 
 "drool", "drove", "drown", "druid", "drunk", "dryer", "dummy", "dusty", 
 "dutch", "duvet", "dwarf", "dwell", "dying", "eager", "eagle", "early", 
 "earth", "easel", "eaten", "ebony", "edict", "edify", "eight", "eject", 
 "elate", "elbow", "elder", "elect", "elite", "elope", "email", "embed", 
 "ember", "empty", "enact", "enemy", "enjoy", "enter", "entry", "envoy", 
 "epoch", "equal", "equip", "erase", "erect", "erode", "error", "fable", 
 "erupt", "essay", "ether", "ethic", "evade", "exist", "expel", "extra", 
 "event", "every", "evict", "evoke", "exact", "exalt", "excel", "exert", 
 "exile", "faint", "fairy", "faith", "false", "fancy", "fatal", "fault", 
 "favor", "feast", "femur", "fence", "feral", "ferry", "fetch", "fetus", 
 "fever", "fewer", "fiber", "field", "fiend", "fiery", "fifth", "fifty", 
 "fight", "filet", "filth", "final", "finer", "first", "fixer", "flail", 
 "flake", "flaky", "flame", "flank", "flare", "flash", "flask", "fleet", 
 "flesh", "flier", "fling", "flint", "flirt", "float", "flock", "flood", 
 "floor", "floss", "flour", "flown", "fluff", "fluid", "fluke", "flung", 
 "flunk", "flush", "flute", "flyer", "foamy", "focal", "focus", "foggy", 
 "force", "forge", "forte", "forth", "forty", "forum", "found", "foyer", 
 "frail", "frame", "fraud", "freak", "freed", "fresh", "friar", "fried", 
 "frisk", "front", "frost", "froth", "frown", "froze", "fruit", "fudge", 
 "fully", "fungi", "funky", "funny", "furry", "fussy", "fuzzy", 
}; /*
                                                                "gaffe", 
 "gaily", "gamer", "gamma", "gamut", "gassy", "gaudy", "gauge", "gaunt", 
 "gauze", "gavel", "gawky", "gayer", "gayly", "gazer", "gecko", "geeky", 
